...
process.on("uncaughtException", function (err) {
	console.log(Utils.colors.error("Whoops! There was an uncaught exception..."));
	console.log("Use the follow trace to get help");
	console.error(Utils.colors.info(err.stack));
